...
docker build . --build-arg BASE_IMAGE=$os_image -t $dragonwell_extended11_image --no-cache -f kylin-V10SP2.dragonwell-extended11.Dockerfile
docker push $dragonwell_extended11_image
