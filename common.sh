...
dragonwell_extended11_image="$dockerhub_repo:v10-sp2-amd64-dragonwell-extended11-$build_date"
...
dragonwell_extended11_maven3_9_image="$dockerhub_repo:v10-sp2-amd64-dragonwell-extended11-maven3.9-$build_date"
