...
docker build . --build-arg BASE_IMAGE=$dragonwell_extended11_image -t $dragonwell_extended11_maven3_9_image --no-cache -f kylin-V10SP2.dragonwell-extended11-maven.Dockerfile
docker push $dragonwell_extended11_maven3_9_image
